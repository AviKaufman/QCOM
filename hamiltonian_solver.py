...
if __name__ == "__main__":
    ...
    print("Constructing the Hamiltonian for the Rydberg chain...\n")
    ...
    hamiltonian = build_rydberg_hamiltonian_chain(num_atoms, Omega, Delta, a, pbc=True)
    print(hamiltonian.toarray())
    print("")

    print("Constructing the Hamiltonian for the Rydberg ladder...\n")
    ...
    hamiltonian = build_rydberg_hamiltonian_ladder(
        num_atoms, Omega, Delta, a, rho=2.0, pbc=True
    )
    print(hamiltonian.toarray())
    print("")

    print("Constructing the Hamiltonian for the 1D Quantum Ising Model...\n")

    # Parameters for the Ising Hamiltonian

    # Parameters for the ising system system
    num_spins = 8  # Number of spins in the system
    ...
    hamiltonian = build_ising_hamiltonian(num_spins, J, h, pbc)

    print(hamiltonian.toarray())
    print("")

    print("Constructing the Hamiltonian for the Quantum Ising Model on a ladder...\n")
    ...
    hamiltonian = build_ising_hamiltonian_ladder(num_spins, J, h, pbc, include_diagonal)
